"""Static codebook tables for IQ2_XXS (exact bytes from ggml source).

Generated mechanically from ggml-common.h GGML_TABLE blocks (see
tools/extract_iq_tables.py logic); do not hand-edit. Layouts:
- IQ2XXS_GRID[256][8]: uint8 magnitudes per 8-group.
- KSIGNS_IQ2XS[128]: 7-bit index -> 8-bit even-parity sign pattern.
- KMASK_IQ2XS[8]: bit mask per position.
"""
import numpy as _np
IQ2XXS_GRID = _np.array([
    8, 8, 8, 8, 8, 8, 8, 8,
    43, 8, 8, 8, 8, 8, 8, 8,
    25, 25, 8, 8, 8, 8, 8, 8,
    8, 43, 8, 8, 8, 8, 8, 8,
...
], dtype=_np.uint8).reshape(256, 8)
KSIGNS_IQ2XS = _np.array([
